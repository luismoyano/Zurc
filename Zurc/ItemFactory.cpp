...
ItemFactory::ItemFactory()
{
	...
	Item* it5 =  new Item("dj_table", "A DJ table playing some tunes driven by your AI Jarvis", 15, 60);
	items.push_back(it5);

	Item* it6 =  new Item("coconut_plant", "What? You thought we couldn't afford having this? HA!", 70, 100);
	items.push_back(it6);

	Item* it7 =  new Item("computer", "A big computer packed of awesome data", 10, 5);
	items.push_back(it7);

	Item* it8 =  new Item("mobile_phone", "Pocket size data", 1, 1);
	items.push_back(it8);
	...
	Item* it11 = new Item("chocolate_bar", "People give you data in exchange for this!", 1, 1);
	items.push_back(it11);

	Item* it12 = new Item("server", "The holy grail of data!!", 100, 80);
	items.push_back(it12);

	Item* it13 = new Item("game_console", "Good for people to evade form the boredom of their jobs!", 2, 3);
	items.push_back(it13);

	Item* it14 = new Item("facebook_Wall", "A wall for people to write more data!", 120, 500);
	items.push_back(it14);

	Item* it15 = new Item("fridge", "A very cold place", 60, 50);
	...
	Item* it19 = new Item("basket_ball", "No data here", 2, 2);
	items.push_back(it19);

	Item* it20 = new Item("time_travel_portal", "Meh no data who cares", 120, 500);
